  ...
  return (
    ...
    >
      ...
      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10}>
        ...
        <Feature
          src={
            <img src={paperplane} alt={"Business Solutions"} w={10} h={10} />
          }
          title={"Business Solutions"}
          text={
            "From brand strategies and advertising campaigns to digital tactics and marketing plans, our solutions are guided by audience research and insights, driven by creativity and developed in close collaboration with our partners. By getting the right audience, we can help you build connections and create lasting change."
          }
        />
      </SimpleGrid>
    </Box>
